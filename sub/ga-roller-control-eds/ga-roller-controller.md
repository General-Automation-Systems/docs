...
3 bit - Input "FAULT" real state means signal is active or not
4 bit - Input "FAULT" NPN detect state, value 1 it means input connect to GND 
5 bit - Input "FAULT" PNP detect state, value 1 it means input connect to VCC 
        NPN = 1 and PNP = 1 at the same time, means no signal or floating input 
	NPN = 0 and PNP = 0 at the same time, means some hardware error of input 
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of Elements    | UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | CH1 - SPD             | INTEGER32  | ro  | no  | no   | 0             |
| 0x02 | CH2 - SPD             | INTEGER32  | ro  | no  | no   | 0             |
| 0x03 | CH3 - SPD             | INTEGER32  | ro  | no  | no   | 0             |
| 0x04 | CH4 - SPD             | INTEGER32  | ro  | no  | no   | 0             |
